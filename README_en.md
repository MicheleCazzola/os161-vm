...
- _coremap_shutdown()_: function responsible for shutting down and cleaning the coremap, freeing allocated memory and deactivating the coremap when the system no longer needs it.
